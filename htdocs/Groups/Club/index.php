...
$id=$_GET['id'];
$getGroup = $handler->prepare("SELECT * FROM groups WHERE id=:id");
$getGroup->bindParam(':id', $id, PDO::PARAM_INT);
$getGroup->execute();
...
<div class="center-align"><form action="/Groups/Club/Join.php?id=<? echo $id ?>" method="POST"><input type="submit" name="JoinGroup" class="groups-green-button center-align" value="Join Group"><input type="hidden" name="csrf_token" value="VoCrOP9owOTkoCXLNxpR5AkeGaiTYAhk1xH1Bjyivso="></form></div>

<? } else { ?>

<div class="center-align"><form action="/Groups/Club/Leave.php?id<?php echo $id ?>" method="POST"><input type="submit" name="JoinGroup" class="groups-red-button center-align" value="Leave"><input type="hidden" name="csrf_token" value="VoCrOP9owOTkoCXLNxpR5AkeGaiTYAhk1xH1Bjyivso="></form></div>
...
<div><?php echo htmlspecialchars($gG->description); ?></div>
...
<div class="col s5.5 center-align" style="margin-top:15px;">



<iframe src="http://bloxcreatefixed.rf.gd/avatar.php?id=<?php echo $gU->id ?>" style="width:200px;height:200px;border:0px;" scrolling="no"></iframe>

<div style="padding-top:3px;">

<a href="/Profile?id=<? echo $gU->id ?>" style="font-size:12px;"><? echo htmlspecialchars($gU->username); ?></a>
